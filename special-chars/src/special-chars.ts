...
import {Transaction, ChangeSet, ChangedRange, Extension, combineConfig} from "../../state/src"
...
export const specialChars = Extension.defineUnique<SpecialCharOptions>(configs => {
